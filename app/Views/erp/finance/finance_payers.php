...
<div id="smartwizard-2" class="border-bottom smartwizard-example sw-main sw-theme-default mt-2">
    <ul class="nav nav-tabs step-anchor">        
        <li class="nav-item clickable">
            <a href="<?= site_url('erp/deposit-list');?>" class="mb-3 nav-link">
                <span class="sw-done-icon feather icon-check-circle"></span>
                <span class="sw-icon feather icon-copy"></span><?= lang('Dashboard.xin_acc_deposit');?>
                <div class="text-muted small">Select pager options</div>
            </a>
        </li>
        <li class="nav-item clickable">
            <a href="<?= site_url('erp/income-type');?>" class="mb-3 nav-link">
                <span class="sw-done-icon feather icon-check-circle"></span>
        ...
        <li class="nav-item active">
            <a href="<?= site_url('erp/payers-list');?>" class="mb-3 nav-link">
                <span class="sw-done-icon feather icon-check-circle"></span>
                <span class="sw-icon feather icon-copy"></span><?= lang('xin_acc_payer');?>
                <div class="text-muted small">Select pager options</div>
            </a>
        </li>
    </ul>
...
<div class="row m-b-1">
  <div class="col-md-4">
    <div class="card">
      ...
      <?php echo form_open('erp/finance/add_payer', $attributes, $hidden);?>
      <div class="card-body">
        <div class="form-group">
          <label for="account_name">
            <?= lang('xin_acc_payer');?>
          </label>
          <input type="text" class="form-control" name="name" placeholder="<?= lang('xin_acc_payer_name');?>">
        </div>
        <div class="form-group">
