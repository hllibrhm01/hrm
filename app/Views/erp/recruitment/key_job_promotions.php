...
<div id="smartwizard-2" class="border-bottom smartwizard-example sw-main sw-theme-default mt-2 mb-3">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active"> <a href="<?= site_url('erp/promotion-list');?>" class="mb-3 nav-link"> <span class="sw-done-icon feather icon-check-circle"></span> <span class="sw-icon feather icon-user-plus"></span>
